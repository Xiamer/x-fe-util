...
const idCardUtil = {
  ...
  getIdCardInfo: function (idCardNo) {
    ...
    if (idCardNo.length == 15) {
      ...
      idCardInfo.birthday = idCardUtil.formateDateCN(aday);
      if (parseInt(idCardNo.charAt(14)) % 2 == 0) {
        idCardInfo.gender = idCardUtil.genders.female;
      } else {
        idCardInfo.gender = idCardUtil.genders.male;
      }
    } else if (idCardNo.length == 18) {
    ...
    idCardInfo.age = idCardUtil.getAge(idCardInfo.birthday)
  ...
  getId18: function (idCardNo) {
    if (idCardNo.length == 15) {
      ...
      let parityBit = idCardUtil.getParityBit(id17);
